...
if (
    ...
    isset($_POST['opportunity_type']) &&
    isset($_POST['description']) && 
    isset($_FILES['attachment'])
) {
    // Retrieve the form data
    $alumni_id = get_post($conn, 'alumni_id');
    $opportunity_type = get_post($conn, 'opportunity_type');
    ...
    if (isset($_FILES["attachment"]) && $_FILES["attachment"]["error"] == 0) {
        ...
        if (in_array($uploadedExtension, $allowedExtensions)) {
            ...
            $filePath = "opportunity-uploads/" . microtime(true) . "." . $uploadedExtension;
            // echo $filePath;
            ...
            echo "<div id='redirectMessage' style='text-align: center; margin: 100px auto; max-width: 800px; padding: 20px; border: 2px solid #e74c3c; border-radius: 10px; background-color: #f5f9fa;'>
                ...
                <script>
                    ...
                    function updateCountdown() {
                        ...
                        if (seconds === 0) {
                            window.location.href = '$BASE_URL/giveback/shareOpportunity.php';
                        } else {
                            seconds--;
    ...
    $query = "INSERT INTO opportunity_details (alumni_id, opportunity_type, description, attachment ) VALUES ('$alumni_id', '$opportunity_type', '$description', '$filePath')";
    ...
    if ($result) {
        echo "<div style='text-align: center; margin: 100px auto; max-width: 800px; padding: 20px; border: 2px solid #34C759; border-radius: 10px; background: linear-gradient(135deg, #34C759, #ecf0f1);'>
                ...
                <p style='color: #2c3e50; font-size: 18px;'>Your opportunity have been successfully shared. Thank you!</p>
